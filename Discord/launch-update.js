...
async function init() {
  var jarak = [
    600000, 1800000, 3600000, 21600000, 86400000, 172800000, 432000000,
  ];
  var message = [
    'T - 10 minutes',
    'T - 30 minutes',
  ...
  var list;
  try {
    list = await async_request(
      'https://fdo.rocketlaunch.live/json/launches/next/100'
    );
    list = list.result;
          ...
          fields: [
            ...
            },
            {
              ...
              value:
                cur.pad.name +
                ', ' +
                cur.pad.location.name +
                ', ' +
                cur.pad.location.statename +
                ', ' +
                cur.pad.location.country,
            },
            {
              name: 'Payload',
              value: payload,
